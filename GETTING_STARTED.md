...
- [Create the `.env` file (PowerShell)](#create-the-env-file-powershell)
- [Run a simple query](#run-a-simple-query)
- [Run a SQL file](#run-a-sql-file)
- [Check PostgreSQL version and info](#check-postgresql-version-and-info)
- [Create a `users` table (SQL file)](#create-a-users-table-sql-file)
- [Insert JSON data (single row)](#insert-json-data-single-row)
- [Insert CSV data (multiple rows)](#insert-csv-data-multiple-rows)
- [List all user tables](#list-all-user-tables)
- [Show table column names](#show-table-column-names)
- [Create a temporary demo table](#create-a-temporary-demo-table)
- [Drop the demo table](#drop-the-demo-table)
- [Create a `sample` JSONB table and insert `sample.json`](#create-a-sample-jsonb-table-and-insert-samplejson)
- [Update nested JSON fields](#update-nested-json-fields-modify-stored-jsonb-data)
- [Quick verification queries](#quick-verification-queries)
- [Resources for PostgreSQL Beginners](#resources-for-postgresql-beginners)
